...
@section('main')
    <div class="container">
        <a href="{{ route('admin.setting.index') }}" class="float-right btn btn-danger mb-2" id="trash">UnTrash</a>
    ...
    <script type="text/javascript">
        $(function() {
            var table = $('.data-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('admin.setting.trashed') }}",
                columns: [{
