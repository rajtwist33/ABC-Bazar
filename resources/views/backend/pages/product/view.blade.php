...
@section('main')
    ...
    <div class="container">
        ...
        <div class="row mt-2 mb-3">
            <h4>Seller Details Information </h4>
            <div class="col-md-6">
                <strong for="validationCustom01" class="form-label">Name</strong>
            ...
            <div class="col-md-6">
                <strong for="validationCustom02" class="form-label">Phone / Whats App Number </strong>
            ...
            <div class="col-md-6">
                <strong for="validationDefault04" class="form-label"> Province</strong>
        ...
        <div class="row">
            <div class="col-md-6 col-lg-3 mb-3">
                ...
                <a href="{{ asset($data_lists->product_image->front_part) }}" target="_blank" rel="noopener noreferrer">
                    <img src="{{ asset($data_lists->product_image->front_part) }}" alt="Front Part Image"
                        class="img-fluid"></a>
            </div>
            <div class="col-md-6 col-lg-3 mb-3">
                <strong for=""> Back part</strong>
                <a href="{{ asset($data_lists->product_image->back_part) }}" target="_blank" rel="noopener noreferrer">
                    <img src="{{ asset($data_lists->product_image->back_part) }}" alt="Front Part Image"
                        class="img-fluid"></a>
            </div>

            @if ($data_lists->product_image->with_battery_percentage)
                <div class="col-md-6 col-lg-3 mb-3">
            ...
            @endif
            @if ($data_lists->product_image->with_box)
                <div class="col-md-6 col-lg-3 mb-3">
                    <strong for=""> With Box</strong>
                    <a href="{{ asset($data_lists->product_image->with_box) }}" target="_blank"
                        rel="noopener noreferrer">
                        <img src="{{ asset($data_lists->product_image->with_box) }}" alt="Front Part Image"
                            class="img-fluid"></a>
                </div>
            @endif
            @if ($data_lists->product_image->with_warrenty)
                <div class="col-md-6 col-lg-3 mb-3">
