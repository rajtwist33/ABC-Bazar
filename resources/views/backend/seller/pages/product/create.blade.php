        ...
        <form action="{{ route('seller.product.store') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    <label for="title" class="form-label fs-4"> Product ID <code>*</code>: <strong id="product_id"
                            class="text-danger">
                ...
                <div class="col-md-6 mb-3">
                    <label for="storage" class="form-label">Storage</label><code>*</code><br>
                    <input type="text" class="form-control" name="storage" id="storage" aria-describedby="emailHelp"
                        value="{{ old('storage') }}">
                    @error('storage')
                        <div class="alert alert-danger mt-1">{{ $message }}</div>
                    @enderror
                ...
                <div class="col-md-6 mb-3">
                    <label for="warrenty_left" class="form-label">Warenty Left</label><code>*</code><br>
                    <input type="text" class="form-control" name="warrenty_left" id="warrenty_left" aria-describedby="emailHelp"
                        value="{{ old('warrenty_left') }}">
                    @error('warrenty_left')
                        <div class="alert alert-danger mt-1">{{ $message }}</div>
                    @enderror
                </div>
